...
// $Id: RemoteImageServerImpl.java,v 1.1 2002/06/16 07:14:13 dustin Exp $
...
public class RemoteImageServerImpl extends UnicastRemoteObject
	 ...
	 */
	public RemoteImageServerImpl(File config) throws RemoteException {
		super();
	...
	public static void main(String args[]) throws Exception {
		...
		RemoteImageServerImpl i=new RemoteImageServerImpl(new File(args[0]));
